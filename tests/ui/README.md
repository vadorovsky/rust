...
## `tests/ui/btf/`: BPF Type Format Relocations

Tests for the experimental `btf_relocations` feature, including attribute placement, field-access
restrictions, and target and debug-info requirements.
