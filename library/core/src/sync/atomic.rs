...
#[cfg(any(all(feature = "nightly", target_has_atomic_load_store), target_has_atomic_load_store = "8"))]
...
#[inline]
#[cfg(any(all(feature = "nightly", target_has_atomic), target_has_atomic = "8"))]
